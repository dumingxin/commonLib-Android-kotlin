...
public class SPUtil {
    ...
    public static <T> boolean saveObjectToShare(String key, T t) {
        return saveObjectToShare(BaseApplication.instance.getApplicationContext(), PreferenceName, key, t);
    }
    ...
    public static <T> T getObjectFromShare(String key) {
        return getObjectFromShare(BaseApplication.instance.getApplicationContext(), PreferenceName, key);
    }
    ...
    public static void saveString(String key, String value) {
        SharedPreferences sp = BaseApplication.instance.getSharedPreferences(PreferenceName,
